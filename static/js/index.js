...
$(document).ready(function() {
  let scanner = new Instascan.Scanner({video: document.getElementById('video-preview')}); // Scanner Preview @ #video-preview
  ...
  Instascan.Camera.getCameras().then(function (cameras) { // Get a list of available cameras
    if (cameras.length > 0) { // If there are any cameras...
      ...
      if (camera_param) { // If so...
        ...
        $(`#camera-picker option[value="cam-placeholder"]`).hide();
      }
    } else {
